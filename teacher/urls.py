...
urlpatterns = [
    ...
    path('view_lesson_file/<int:lesson_id>', ViewFilesViewset.as_view(), name='view_lesson_file'),
    path('delete_lesson_file/<int:lesson_file_id>/', delete_lesson_file, name='delete_lesson_file'),
    path('delete_lesson_file2/<int:lesson_file_id>/', delete_lesson_file2, name='delete_lesson_file2'),
